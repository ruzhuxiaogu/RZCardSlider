...
@optional
///点击了某个卡片
- (void)sliderDidSelectCardAtIndex:(NSInteger)index firstPositionIndex:(NSInteger)firstPositionIndex cardView:(QNCardContentView *)cardView;
///每个卡片的缩放程度
